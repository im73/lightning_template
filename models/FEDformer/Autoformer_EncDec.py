...
import math
from models.FEDformer.SelfAttention_Family import FullAttention
...
class Decoder(nn.Module):
    ...
    Autoformer encoder
    """
    def __init__(self, layers, norm_layer=None, projection=None, projection2=None):
